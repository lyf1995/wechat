...
CREATE TABLE `t_address` (
  ...
  `contacts` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  ...
  `detail_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `t_address` VALUES (6, '张三', '12345678987', '北京市', '北京市', '东城区', '测试', 1, 9, 0);
COMMIT;
...
CREATE TABLE `t_goods` (
  ...
  `subtitle` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `stock` float(10,0) DEFAULT NULL,
  `main_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `carousel_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `detail_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
...
INSERT INTO `t_goods` VALUES (6, '马达加斯加Aqualma黑虎虾 800g/盒 30-35尾/kg', 198, 218, '马达加斯加-红树林生态保护区出产的黑虎虾享有“虾中香奈儿”的美誉。', 99, NULL, '', '', 1, 0);
...
INSERT INTO `t_goods_order` VALUES (11, 6, 43, 1, 198, '马达加斯加Aqualma黑虎虾 800g/盒 30-35尾/kg', NULL);
COMMIT;
...
CREATE TABLE `t_goods_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `type_describe` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `is_delete` int(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
...
CREATE TABLE `t_order` (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '0-未付款，1-待发货，2-待收货，3-已完成，4-已取消',
  `user_id` int(11) NOT NULL,
  `address_id` int(11) NOT NULL,
  `total_amount` float(255,0) DEFAULT NULL,
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
...
INSERT INTO `t_order` VALUES (43, 'lyf1571563305480', '3', 9, 6, 198, '', '2019-10-20 17:21:45', 0, 0);
COMMIT;
...
CREATE TABLE `t_rebate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `regist_rebate` float DEFAULT NULL,
  `buy_rebate` float DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `t_rebate` VALUES (1, 500, 50);
COMMIT;
...
INSERT INTO `t_shoppingcar` VALUES (14, 9, 6, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES (1, 'admin', 'admin', '系统管理员', NULL, '2018-05-06 00:00:00', '2019-10-20 17:01:20', '0', 0);
...
INSERT INTO `t_user` VALUES (8, '12312312322', '123', '', 1000, '2018-05-09 10:59:09', NULL, '1', 1);
INSERT INTO `t_user` VALUES (9, '11111111111', 'admin', '', 9802, '2019-10-20 17:18:07', '2019-10-20 17:20:21', '0', 1);
COMMIT;
